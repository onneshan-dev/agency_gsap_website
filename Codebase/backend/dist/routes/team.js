...
router.post('/members', requireAdmin, validate(createTeamMemberSchema), async (req, res) => {
    try {
...
router.post('/projects/:projectId/team', requireAdmin, async (req, res) => {
    try {
...
router.delete('/projects/:projectId/team/:userId', requireAdmin, async (req, res) => {
    try {
