...
router.get('/:projectId/deliverables', requireAny, async (req, res) => {
    try {
...
router.post('/:projectId/deliverables', requireAdminOrTeam, async (req, res) => {
    try {
...
router.patch('/:id/status', requireAny, async (req, res) => {
    try {
