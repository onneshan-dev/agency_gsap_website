...
router.post('/conversations', requireAny, async (req, res) => {
    try {
...
router.get('/conversations/:id/messages', requireAny, async (req, res) => {
    try {
...
router.post('/conversations/:id/messages', requireAny, async (req, res) => {
    try {
